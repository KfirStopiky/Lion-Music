(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-img-zoom', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-img-zoom'] = {}, global.ng.core, global.ng.common));
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxImgZoomService, [{
    ...
    var NgxImgZoomComponent = /** @class */ (function () {
        ...
        NgxImgZoomComponent.propDecorators = {
            imgElmRef: [{ type: core.ViewChild, args: ['img', { static: false },] }],
            resultElmRef: [{ type: core.ViewChild, args: ['result', { static: false },] }],
            containerElmRef: [{ type: core.ViewChild, args: ['container', { static: false },] }],
            enableZoom: [{ type: core.Input }],
            imgStyle: [{ type: core.Input }],
            resultStyle: [{ type: core.Input }],
            lensStyle: [{ type: core.Input }],
            containerStyle: [{ type: core.Input }],
            onscroll: [{ type: core.HostListener, args: ['window:scroll', ['$event'],] }],
            onclick: [{ type: core.HostListener, args: ['window:click', ['$event.target'],] }],
            _imgSrc: [{ type: core.Input, args: ['zoomImageSrc',] }],
            _zoomImage: [{ type: core.Input, args: ['previewImageSrc',] }]
        };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxImgZoomModule, { declarations: [NgxImgZoomComponent, MouseWheelDirective], imports: [ɵngcc1.CommonModule], exports: [NgxImgZoomComponent] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxImgZoomModule, [{
    ...
    exports.NgxImgZoomComponent = NgxImgZoomComponent;
    exports.NgxImgZoomModule = NgxImgZoomModule;
    exports.NgxImgZoomService = NgxImgZoomService;
    exports.ɵa = MouseWheelDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));

//# sourceMappingURL=ngx-img-zoom.umd.js.map